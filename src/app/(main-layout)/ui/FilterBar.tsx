...
const FilterBar = ({
  ...
  const FilterButton = ({ option }: { option: FilterOption }) => (
    <button
      className={`sm:text-sm font-medium border hover:bg-gray-200/80 active:bg-gray-200 bg-gray-50 pr-2 sm:pr-1.5 h-9 sm:h-8 flex items-center gap-1 justify-center rounded-full cursor-pointer active:scale-98 shrink-0 relative ${
