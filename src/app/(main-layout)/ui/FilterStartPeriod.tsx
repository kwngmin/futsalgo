...
const FilterStartPeriod = ({
  ...
  const getPeriodButtonClass = useCallback((isSelected: boolean) => {
    return cn(
      "shrink-0 cursor-pointer w-20 sm:w-14 h-9 sm:h-8 flex items-center justify-center rounded-sm sm:text-sm border transition-colors",
      isSelected
  ...
  const allButtonClass = useMemo(
    () =>
      cn(
        "cursor-pointer w-20 sm:w-24 h-9 sm:h-8 flex items-center justify-center rounded-sm sm:text-sm border transition-colors shrink-0",
