      ...
      <div className="px-3 space-y-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2 justify-between">
            ...
            <button className="shrink-0 w-9 h-9 flex items-center justify-center text-gray-600 bg-gray-50 hover:bg-white rounded-full transition-colors cursor-pointer bg-gray-100 mr-3">
