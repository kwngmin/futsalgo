...
const RegisterTeamButton = ({ onClick }: RegisterTeamButtonProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="fixed bottom-24 md:left-20 lg:left-72 md:bottom-0 left-0 right-0 sm:max-w-xs md:max-w-2xl mx-4 sm:mx-auto shrink-0 h-12 sm:h-11 flex items-center justify-between bg-emerald-600 text-white hover:bg-emerald-800 rounded-full md:rounded-b-none md:rounded-t-2xl cursor-pointer font-semibold z-20 px-3 active:bg-emerald-900 active:scale-98 transition-all shadow-md inset-shadow-sm inset-shadow-white/50"
    >
