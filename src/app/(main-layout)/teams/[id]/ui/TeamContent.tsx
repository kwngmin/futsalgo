          ...
          <div className="border-b border-gray-300 space-y-4">
            ...
            data.data.currentUserMembership.role === "OWNER" ? (
              <Button
                variant="outline"
                size="lg"
                className="mx-4 w-full text-base font-semibold cursor-pointer"
                onClick={() => {
                  setIsLoading(true);
              ...
              data.data.recruitmentStatus === "RECRUITING" ? (
                <Button
                  className="mx-4 w-full text-base font-semibold bg-gradient-to-r from-indigo-600 to-emerald-600"
                  size="lg"
                  onClick={async () => {
                    if (session.data) {
                      try {
              ...
              // </div>
              <Button
                className="mx-4 w-full text-base font-semibold"
                size="lg"
                variant="outline"
                onClick={async () => {
                  try {
              ...
              data.data.currentUserMembership.status === "REJECTED" && (
                <div className="mx-4 flex items-center justify-between bg-red-400/10 rounded-lg p-2">
                  <div className="flex items-center px-2">
