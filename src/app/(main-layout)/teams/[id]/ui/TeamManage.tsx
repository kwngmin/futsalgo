    ...
    <div className="select-none">
      {isOpen === null && (
        <div className="grid grid-cols-3 gap-2">
          <button
            type="button"
            className="cursor-pointer rounded-md flex flex-col sm:flex-row justify-center sm:items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-0 sm:h-11 font-semibold bg-white border border-gray-400 transition-shadow shadow-xs hover:shadow-md w-full mb-3 text-start disabled:opacity-40 disabled:cursor-default"
