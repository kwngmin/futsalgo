...
const MatchStatsLeaderboard: React.FC<MatchStatsLeaderboardProps> = ({
  ...
  const getRankBadgeStyle = (rank: PlayerStats["rank"]) => {
    switch (rank) {
      case "gold":
        return "bg-gradient-to-br from-yellow-400 to-yellow-500 inset-shadow-sm inset-shadow-yellow-200 shadow-md text-white";
      case "silver":
        return "bg-gradient-to-br from-gray-100 to-gray-300 inset-shadow-sm inset-shadow-white shadow-md text-gray-800";
      case "bronze":
