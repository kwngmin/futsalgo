import SkeletonPlayerContent from "./ui/SkeletonPlayerContent";
    ...
    <div className="max-w-2xl mx-auto pb-16 flex flex-col">
      <div className="flex items-center justify-between px-4 h-16 shrink-0">
        <div className="flex gap-3">
          <h1 className="text-[1.625rem] font-bold cursor-default">회원</h1>
      ...
      <SkeletonPlayerContent />
    </div>
  );
};

export default PlayersPageLoading;
