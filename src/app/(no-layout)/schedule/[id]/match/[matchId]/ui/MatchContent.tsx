    ...
    <div className="max-w-2xl mx-auto pb-16 flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 h-16 shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button className="shrink-0 px-3 h-10 flex items-center gap-1 text-sm font-semibold justify-center text-gray-700 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 rounded-full transition-colors cursor-pointer">
