...
const ScheduleFilterBar = ({
  ...
  const FilterButton = ({ option }: { option: FilterOption }) => (
    <button
      className={`sm:text-sm font-medium bg-gray-50 hover:bg-gray-100 border active:bg-gray-200 pr-2 lg:pr-1.5 h-10 lg:h-9 flex items-center gap-1 justify-center rounded-full cursor-pointer active:scale-98 shrink-0 relative p-1 ${
