    ...
    <div className={cn("flex flex-col gap-2", className)}>
      ...
      <div className="relative">
        <select
          ...
          data-error={error}
          className={cn(
            "appearance-none text-sm h-10 border border-input rounded-md px-3 data-[error=true]:outline-destructive cursor-pointer disabled:cursor-default disabled:opacity-50 disabled:pointer-events-none w-full",
